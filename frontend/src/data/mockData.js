...
export const taskSeed = [
  { id: "t1", projectId: "p2", title: "Analisis kebutuhan modul NICU", status: "done", priority: "High", assignee: 1, labels: ["Analysis"], dueDate: "2026-09-01", checklist: [{ text: "Wawancara unit NICU", done: true }, { text: "Dokumentasi kebutuhan", done: true }], comments: 3, attachments: 2, description: "Menggali kebutuhan fungsional dari unit NICU untuk modul pemantauan neonatal." },
  { id: "t2", projectId: "p2", title: "Mapping form assessment dokter", status: "done", priority: "Medium", assignee: 6, labels: ["Design"], dueDate: "2026-09-03", checklist: [{ text: "Review form eksisting", done: true }], comments: 1, attachments: 1, description: "Memetakan form assessment dokter ke struktur data digital." },
  { id: "t3", projectId: "p2", title: "Implementasi Modul NICU", status: "inprogress", priority: "High", assignee: 1, labels: ["Frontend", "Backend"], dueDate: "2026-09-18", checklist: [{ text: "Analisis kebutuhan", done: true }, { text: "Mapping form", done: true }, { text: "Implementasi frontend", done: false }, { text: "Implementasi backend", done: false }, { text: "Testing", done: false }, { text: "UAT", done: false }], comments: 5, attachments: 4, description: "Membangun modul NICU end-to-end mencakup frontend dan backend, termasuk integrasi data vital pasien." },
  { id: "t4", projectId: "p2", title: "Implementasi API pasien", status: "inprogress", priority: "High", assignee: 3, labels: ["Backend"], dueDate: "2026-09-14", checklist: [{ text: "Desain endpoint", done: true }, { text: "Implementasi", done: false }], comments: 2, attachments: 0, description: "Membangun REST API untuk data pasien NICU." },
  { id: "t5", projectId: "p1", title: "Testing modul rawat inap", status: "review", priority: "Medium", assignee: 4, labels: ["QA"], dueDate: "2026-09-10", checklist: [{ text: "Buat test case", done: true }, { text: "Eksekusi test", done: true }], comments: 4, attachments: 1, description: "Pengujian fungsional modul rawat inap sebelum rilis." },
  { id: "t6", projectId: "p1", title: "Dokumentasi business process", status: "todo", priority: "Low", assignee: 6, labels: ["Docs"], dueDate: "2026-09-25", checklist: [], comments: 0, attachments: 0, description: "Menyusun dokumentasi alur proses bisnis SIMRS." },
  { id: "t7", projectId: "p3", title: "Demo SIMRS ke unit", status: "todo", priority: "Medium", assignee: 1, labels: ["Meeting"], dueDate: "2026-09-20", checklist: [], comments: 1, attachments: 0, description: "Presentasi demo aplikasi ke unit kamar bedah." },
  { id: "t8", projectId: "p5", title: "Perbaikan hasil UAT", status: "review", priority: "High", assignee: 3, labels: ["Bugfix"], dueDate: "2026-09-12", checklist: [{ text: "Kumpulkan temuan UAT", done: true }, { text: "Perbaikan", done: false }], comments: 6, attachments: 3, description: "Menindaklanjuti temuan hasil User Acceptance Test." },
  { id: "t9", projectId: "p5", title: "Deployment production", status: "done", priority: "High", assignee: 1, labels: ["DevOps"], dueDate: "2026-09-05", checklist: [{ text: "Backup database", done: true }, { text: "Deploy", done: true }], comments: 2, attachments: 0, description: "Rilis modul integrasi laboratorium ke lingkungan produksi." },
  { id: "t10", projectId: "p4", title: "Wireframe modul kebidanan", status: "todo", priority: "Medium", assignee: 5, labels: ["Design"], dueDate: "2026-09-22", checklist: [], comments: 0, attachments: 1, description: "Membuat wireframe alur pencatatan persalinan." },
  { id: "t11", projectId: "p1", title: "Review keamanan API", status: "inprogress", priority: "High", assignee: 3, labels: ["Security"], dueDate: "2026-09-16", checklist: [{ text: "Audit endpoint", done: false }], comments: 1, attachments: 0, description: "Audit keamanan pada seluruh endpoint API SIMRS." },
  { id: "t12", projectId: "p6", title: "Sinkronisasi data eLLIMS", status: "done", priority: "Medium", assignee: 2, labels: ["Integration"], dueDate: "2026-07-28", checklist: [{ text: "Mapping field", done: true }, { text: "Testing sync", done: true }], comments: 3, attachments: 2, description: "Menyelaraskan struktur data antara SIMRS dan eLLIMS." },
];
